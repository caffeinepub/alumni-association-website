  ...
  return (
    <div className="pt-16">
      <HeroSection
        ...
        subtitle="Stay connected with the latest events, workshops, and gatherings organized by the alumni association."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h2 className="font-serif text-2xl font-bold text-foreground">
              {isLoading ? "Loading..." : `${upcoming.length} Upcoming Events`}
            </h2>
          </div>
          {isLoading ? (
