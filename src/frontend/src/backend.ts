...
export class Backend implements backendInterface {
    ...
    async addReplyToThread(arg0: string, arg1: Reply): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addReplyToThread(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createEvent(arg0: Event): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createEvent(await to_candid_Event_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createJobPost(arg0: JobPost): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createJobPost(to_candid_JobPost_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createThread(arg0: Thread): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchByNameBatchDepartment(arg0: string, arg1: bigint, arg2: string): Promise<Array<AlumniProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByNameBatchDepartment(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EventType_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EventType): EventType {
...
function from_candid_JobPost_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _JobPost): JobPost {
...
async function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        eventType: from_candid_EventType_n24(_uploadFile, _downloadFile, value.eventType)
    };
}
...
function from_candid_variant_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "upcoming" in value ? EventType.upcoming : "past" in value ? EventType.past : "webinar" in value ? EventType.webinar : "reunion" in value ? EventType.reunion : value;
}
function from_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "job" in value ? PostType.job : "internship" in value ? PostType.internship : value;
}
...
function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_JobPost>): Array<JobPost> {
    return value.map((x)=>from_candid_JobPost_n27(_uploadFile, _downloadFile, x));
}
...
function to_candid_EventType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EventType): _EventType {
    return to_candid_variant_n14(_uploadFile, _downloadFile, value);
}
async function to_candid_Event_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Event): Promise<_Event> {
...
function to_candid_JobPost_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JobPost): _JobPost {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        location: value.location,
        eventType: to_candid_EventType_n13(_uploadFile, _downloadFile, value.eventType)
    };
}
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        postType: to_candid_PostType_n17(_uploadFile, _downloadFile, value.postType),
        title: value.title,
        postedBy: value.postedBy,
        description: value.description,
        isActive: value.isActive,
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EventType): {
    upcoming: null;
} | {
    past: null;
} | {
    ...
    return value == EventType.upcoming ? {
        upcoming: null
    } : value == EventType.past ? {
        past: null
    } : value == EventType.webinar ? {
        webinar: null
    } : value == EventType.reunion ? {
        reunion: null
    } : value;
}
